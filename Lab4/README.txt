...
STEP 1:
First open the 'load_I_T_from_file.vi' to load the input and target data. RUN the VI. In the front panel, set: Hidden Layers to '1' AND Nodes Per Stage to '5','8','3'. 
Click OK to select 'input_data' first, followed by 'targets'. The Inputs Shuffled and Targets shuffled should be displayed in the front panel window. 
